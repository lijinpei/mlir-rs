...
impl<'ctx> Value<'ctx> {
    ...
    pub fn block_arg_get_owner(self) -> Block<'ctx> {
        unsafe { mlir_capi::IR::FFIVal_::mlirBlockArgumentGetOwner(&self) }
    }
    ...
    pub fn op_res_get_owner(self) -> Operation<'ctx> {
        unsafe { mlir_capi::IR::FFIVal_::mlirOpResultGetOwner(&self) }
    }
    ...
    pub fn get_type(self) -> Type<'ctx> {
        unsafe { mlir_capi::IR::FFIVal_::mlirValueGetType(&self) }
    }
...
impl<'ctx> OpOperand<'ctx> {
    ...
    pub fn get_owner(self) -> Operation<'ctx> {
        unsafe { mlir_capi::IR::FFIVal_::mlirOpOperandGetOwner(&self) }
    }
